...
class Landell_sigma_delta(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "Landell_sigma_delta")
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_float*1, '/home/fabio/Compartilhada/erro.dat', False)
        self.blocks_file_sink_0.set_unbuffered(False)
        self.blocks_delay_0 = blocks.delay(gr.sizeof_float*1, 1205)
        self.blocks_complex_to_mag_0 = blocks.complex_to_mag(1)
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_SIN_WAVE, 400, 0.4, 0.5, 0)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 500, 300, window.WIN_HAMMING, 6.76))
        self.low_pass_filter_1.set_taps(firdes.low_pass(1, self.samp_rate, 3000, 500, window.WIN_HAMMING, 6.76))
...
def main(top_block_cls=Landell_sigma_delta, options=None):
