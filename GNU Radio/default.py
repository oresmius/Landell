...
class default(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Landell", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Landell")
        ...
        self.qtgui_freq_sink_x_0 = qtgui.freq_sink_c(
            ...
            0, #fc
            samp_rate, #bw
            "Espectro complexo após Hilbert", #name
            1,
            None # parent
        )
        ...
        self.blocks_wavfile_source_0 = blocks.wavfile_source('/home/fabio/Downloads/34210__acclivity__i-am-female.wav', True)
        ...
        self.band_pass_filter_0 = filter.fir_filter_fff(
            ...
            firdes.band_pass(
                ...
                window.WIN_HAMMING,
                6.76))
        self.audio_sink_0 = audio.sink(samp_rate, 'plughw:CARD=Device,DEV=0', True)
        ...
        self.connect((self.hilbert_fc_0, 0), (self.qtgui_freq_sink_x_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.band_pass_filter_0.set_taps(firdes.band_pass(1, self.samp_rate, 300, 2700, 300, window.WIN_HAMMING, 6.76))
